  ...
  return (
    <main className="min-h-screen">
      ...
      <div className="sm:ml-64 max-w-4xl mx-auto px-4 py-8">
        <h1 className="text-3xl font-bold mb-8 text-center">Confissão de Fé de Westminster</h1>
        
        <div className="mb-6 relative">
          <div className="relative">
            <input
              type="text"
              placeholder="Pesquisar capítulo ou conteúdo..."
          ...
          {isSearching && (
            <div className="mt-2 text-sm text-gray-500 dark:text-gray-400">
              {filteredConfissao.length === 0 
                ? 'Nenhum resultado encontrado' 
                : `Encontrados ${filteredConfissao.length} resultados`}
            </div>
          )}
        </div>
        
        <div className="space-y-4">
          {filteredConfissao.map((item) => (
